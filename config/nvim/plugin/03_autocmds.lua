...
local function toggle_cursorline(buf, enable)
	...
	vim.wo.cursorline = enable == nil and true or enable
	if vim.wo.number then
		vim.wo.relativenumber = enable == nil and true or enable
	end
end
...
vim.api.nvim_create_autocmd({ "FocusLost", "InsertEnter", "WinLeave" }, {
	...
	pattern = "*",
	callback = function(event)
		toggle_cursorline(event.buf, false)
	end,
})
